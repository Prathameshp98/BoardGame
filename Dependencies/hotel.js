...
export function Hotel(player,index,moves,playerMoney,bankMoney,asset,asset_type) {

    if(asset[index] != 0 && asset[index] != player){
        propertyCharge(player,index,moves,playerMoney,bankMoney,asset,asset_type);
